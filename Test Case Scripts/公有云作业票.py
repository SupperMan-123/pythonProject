...
# 点击作业安全管理系统
driver.find_element(By.XPATH,'//*[@id="x-aside-app"]/div[1]/div[3]/div[1]/div[12]/div[1]/span').click()
#等待3秒钟 待页面加载完毕
time.sleep(3)
# 点击作业许可
#driver.find_element(By.XPATH,'//*[@id="x-aside-app"]/div[1]/div/div[1]/div[12]/div[2]/ul/li[3]/div/div[1]/p').click()
# 点击动火作业
driver.find_element(By.XPATH,'//*[@id="x-aside-app"]/div[1]/div/div[1]/div[12]/div[2]/ul/li[3]/div/div[2]/div[1]').click()
# 点击添加
driver.find_element(By.XPATH,'//*[@id="J_body"]/div/div/div/div[2]/div/div/div[1]/div/div[2]/div/div/div/div/div/div[1]').click()
